  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-neutral-50 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-sm text-center">
        ...
        <h1 className="text-2xl font-display font-bold text-marinho">Pagamento não concluído</h1>
        ...
        <div className="mt-6 space-y-3">
          <Link
            to="/planos"
            className="block w-full rounded-lg bg-teal-600 py-2.5 text-sm font-semibold text-white hover:bg-teal-700"
          >
            Tentar novamente
          </Link>
          <Link
            to="/playlists"
            className="block w-full rounded-lg border border-neutral-300 py-2.5 text-sm font-medium text-neutral-700 hover:bg-neutral-50"
          >
